...
public:
	...
	static constexpr AddressPtr<uint8_t, 0x11F91C4> ucSceneGraph;

	static constexpr AddressPtr<int32_t, 0x11F9430> iLetterboxWidth;
	static constexpr AddressPtr<int32_t, 0x11F9434> iLetterboxHeight;

	static constexpr AddressPtr<NiCamera*, 0x11F917C> pCamera;

	static constexpr AddressPtr<BSRenderedTexture*, 0x11F9438> pCurrentRenderTarget;
	static constexpr AddressPtr<BSRenderedTexture*, 0x11F943C> pWaterRefractionTexture;

	static BSTextureManager* GetTextureManager();

	static BSRenderedTexture* GetCurrentRenderTarget();
